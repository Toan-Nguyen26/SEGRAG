...
python test_accuracy.py --cuda --model checkpoints_new/best_model.t7 --wiki --dataset quality --is_json True --bs 1 --seg_threshold 0.27 --min_range 96 --max_range 98

python test_accuracy.py --cuda --model checkpoints_new/best_model.t7 --wiki --dataset narrativeqa --is_json True --bs 1 --seg_threshold 0.27 --min_range 94 --max_range 97
